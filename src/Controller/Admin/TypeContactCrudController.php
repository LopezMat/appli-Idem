...
class TypeContactCrudController extends AbstractCrudController
{
    ...
    public function configureActions(Actions $actions): Actions
    {
        ...
        return $actions
            ...
            ->update(
                Crud::PAGE_INDEX,
                Action::NEW,
                fn (Action $action) => $action->setIcon('fa fa-add')->setLabel('Nouveau type de contact')->setCssClass('btn btn-success')
            )
            ->update(
                Crud::PAGE_INDEX,
                Action::EDIT,
